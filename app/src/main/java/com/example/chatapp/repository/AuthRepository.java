...
public class AuthRepository {
    private static final String TAG = "fireAuthonotcomleteSignUp";
    private static final String TAG2 = "fireAuthonotcomleteSignIn";
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    firebaseFirestore.collection("users").document(userId).set(userHashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        private static final String TAG = "firestorenotcompleteSignUp";
